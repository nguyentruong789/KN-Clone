...
public class Explodable : MonoBehaviour
{
    ...
    public void RetrieveFragments()
    {
        foreach (var frag in fragments)
        {
            ...
            var oriPos = frag.GetComponent<FragmentOriginalPos>();
            if (oriPos != null)
            {
                frag.transform.localPosition = oriPos.OriPos;
    ...
    public void SetFragmentOriginalPosition()
    {
        foreach (var frag in fragments)
        {
            var comp = frag.AddComponent<FragmentOriginalPos>();
            comp.OriPos = frag.transform.localPosition;
        }
    }
    /// <summary>
